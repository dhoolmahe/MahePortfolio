...
return ( <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white font-sans">
{/* Header */} <header className="bg-gray-900 bg-opacity-80 shadow p-6 backdrop-blur-md"> <div className="max-w-5xl mx-auto flex justify-between items-center"> <h1 className="text-3xl font-bold tracking-wide">Mahendran Visvanathan</h1> <nav className="space-x-6"> <a href="#about" className="hover:text-gray-300 transition-colors">About</a> <a href="#skills" className="hover:text-gray-300 transition-colors">Skills</a> <a href="#projects" className="hover:text-gray-300 transition-colors">Projects</a> <a href="#resume" className="hover:text-gray-300 transition-colors">Resume</a> <a href="#contact" className="hover:text-gray-300 transition-colors">Contact</a> </nav> </div> </header>
  ...
  {/* About Section */}
  <motion.section id="about" className="py-20 px-6 bg-gray-800 bg-opacity-70 backdrop-blur-md rounded-xl mx-6 mb-12" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
  ...
  {/* Skills Section */}
  <motion.section id="skills" className="py-20 px-6" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {['Java','Spring Boot','Spring WebFlux','Microservices','Kubernetes','Docker','Kafka','PostgreSQL','React','TypeScript','Azure','AWS'].map(skill => (
          <div key={skill} className="bg-gray-700 bg-opacity-60 hover:bg-gray-600 transition-all p-4 rounded-2xl text-center text-white shadow-md">
            {skill}
          </div>
        ))}
      </div>
  ...
  {/* Projects Section */}
  <motion.section id="projects" className="py-20 px-6 bg-gray-900 bg-opacity-80 rounded-xl mx-6 mb-12" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
    <div className="max-w-5xl mx-auto">
  ...
  {/* Resume Section */}
  <motion.section id="resume" className="py-20 px-6 text-center" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
  ...
  {/* Contact Section */}
  <motion.section id="contact" className="py-20 px-6 bg-gray-800 bg-opacity-70 backdrop-blur-md rounded-xl mx-6 mb-12" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
